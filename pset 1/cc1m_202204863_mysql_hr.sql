...
ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT 'o surpervisor direto do empregdo (auto-relacionamento)';
...
(0, 'Steven King', 'SKING', '515.123.4567', '2003-06-17', 'AD_PRES', 24000, null, 100, 90);
INSERT INTO empregados (id_empregado, nome, email, telefone, data_contratacao, id_cargo, salario, comissao, 
id_supervisor, id_departamento) VALUES
